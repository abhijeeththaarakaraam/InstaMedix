        ...
        <div className='flex-col'>
          ...
          {state.data && (
            ...
            <div className='flex flex-wrap justify-center px-4 md:px-10 py-4 gap-6'>
              {/* Left: Doctor Image + Specialization */}
                ...
                <div className='w-full py-8 px-5 md:px-10'>
                  ...
                  <div className='flex flex-wrap -mx-3'>
                    <div className='w-full md:w-1/2 px-3 mb-4'>
                      <label className='text-xs px-1 text-black'>Name</label>
                      <div className='pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 bg-gray-200'>
                        {state.data.name}
                      </div>
                    </div>
                    <div className='w-full md:w-1/2 px-3 mb-4'>
                  ...
                  <div className='flex justify-end'>
                    <Link
                      className='bg-yellow-300 hover:bg-yellow-400 font-bold py-2 px-4 mt-6 rounded inline-flex'
                      to={{
                        pathname: `/doctor/profile/edit`,
                        state: { data: state.data },
                      }}
