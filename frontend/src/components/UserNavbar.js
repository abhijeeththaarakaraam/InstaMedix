...
//                   <h1 className='text-lg'>InstaMedix</h1>
//                   <div className='-mr-2'>
...
/* resuable navigation bar for every user type */
import { Fragment } from 'react';
import { Popover, Transition } from '@headlessui/react';
import { Link } from 'react-router-dom';
import { useFetchUser } from '../context/userContext';
...
export default function UserNavbar() {
  ...
  const staffExtraDropdown =
    state.data?.type === 'staff' ? managementDropDown : [];
                  ...
                  <Popover className='relative'>
                    {({ open }) => (
                      <>
                        ...
                        >
                          <span className='text-lg font-fontPro text-gray-800 hover:text-gray-500'>
                            User Management <i className='fas fa-chevron-down text-sm'></i>
                          </span>
                        </Popover.Button>
                        <Transition
                          as={Fragment}
                          ...
                          leaveTo='opacity-0 translate-y-1'
                        >
                          <Popover.Panel className='origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white'>
                            <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden'>
                              <div className='relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8'>
                                {managementDropDown.map((item) => (
                                  <a
                ...
                <Popover className='relative'>
                  {({ open }) => (
                    <>
                      ...
                      >
                        <span className='text-lg font-fontPro text-gray-800 hover:text-gray-500'>
                          Profile <i className='fas fa-chevron-down text-sm'></i>
                        </span>
                      </Popover.Button>
                      <Transition
                        as={Fragment}
          ...
          >
            <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50'>
              <div className='pt-5 pb-6 px-5'>
                ...
                <div className='mt-6'>
                  <nav className='grid gap-y-8'>
                    {[...staffExtraDropdown, ...dropdown].map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
